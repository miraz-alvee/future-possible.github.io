        ...
        <div className="">
            <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center p-6">
                    <Card className="w-[740px] max-w-2xl h-[800px] mx-auto bg-[#FFFFFF] shadow-lg border-none rounded-4xl">
                        <CardHeader>
                            <CardTitle className="font-poppins font-bold text-5xl leading-[100%] tracking-normal capitalize p-10">Log In</CardTitle>
                            ...
                            <form className="px-10">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <div className="flex items-center text-[#682ECC] font-poppins font-medium text-base leading-[100%]">
                        ...
                        <CardFooter className="flex-col gap-2 space-y-4">
                            ...
                            <CardAction className="flex mx-auto mt-3">
                                ...
                                <Link href="/signup">
                                    <Button variant="link" className="font-poppins text-[#682ECC] text-lg font-semibold leading-8">Sign Up</Button>
                                </Link>
                            </CardAction>
                        </CardFooter>
                    </Card>
